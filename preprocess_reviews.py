...
def main() -> None:
    ...
    # Summary statistics: average rating, rating distribution, unique reviewers, average reviews per reviewer.
    print("\nSUMMARY STATISTICS")
    raw_ratings = (
        df["Rating"]
        .astype("string")
    ...
    print(f"Average Rating: {raw_ratings.mean():.2f}")
    print("\nRating Distribution:")
    print(raw_ratings.value_counts().sort_index().to_string())
    ...
    print(f"Average Reviews Per Reviewer: {raw_review_counts.mean():.2f}")
